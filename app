...
# Reduced size for the chat interface subtitle
st.markdown(
    """
    <h2 style='text-align: center; font-size: 18px; margin-top: -10px;'>
        Chat Interface
    </h2>
    """,
    unsafe_allow_html=True,
...
# HTML for OpenAI-style fixed chat box
chat_html = """
...
<style>
  ...
  .chat-input textarea {
    ...
    padding: 10px;
    border-radius: 5px;
    height: 40px; /* Fixed height for compact input */
  }
